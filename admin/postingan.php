        ...
        <div class="row">
          ...
          <div class="col-md-2">
            <div class="dropdown create">
              <a href="tambahpost.php" class="btn btn-default dropdown-toggle" type="button" id="dropdownMenu1">
                Tambah Konten</a>
            </div>
          </div>
        </div>
              ...
              <div class="panel-body">
                ...
                <table class="table table-striped table-hover">
                      ...
                      <tr>
                        ...
                        <td><a class="btn btn-default" href="editpost.php?idobat=<?php print $m['id_obat'] ?>">Edit</a> <a class="btn btn-danger" href="deletepostingan.php?idobat=<?php print $m['id_obat'] ?>">Delete</a></td>
                      </tr>
                    <?php } ?>
                    </table>
              </div>
